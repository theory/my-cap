...
# tsql-indent
download http://www.emacswiki.org/cgi-bin/wiki/download/tsql-indent.el
emacs -batch -f batch-byte-compile tsql-indent.el
cp tsql-indent.el* /usr/local/share/emacs/site-lisp
