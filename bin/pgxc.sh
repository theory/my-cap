...
download http://downloads.sourceforge.net/project/postgres-xc/Version_$VERSION/pgxc_v$VERSION.tar.gz
echo Unpacking $file...
rm -rf pgxc_v$VERSION
tar jxf pgxc_$VERSION.tar.bz2 || exit $?
cd pgxc
